...
- Centralized version constant in `internal/version/version.go`.
- Configurable `--width` / `--height` flags documented in README.

### Changed

- README updated to reflect configurable resolution and unified binary.
